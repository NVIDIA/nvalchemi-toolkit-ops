...
For small systems with large cutoffs (e.g., 128 atoms at 15 Å or 25 Å),
the simulation cell may be smaller than 2×cutoff, violating the minimum
image convention. These points are included for completeness but should
