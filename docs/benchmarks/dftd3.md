...
The 25 Å cutoff at ~128k total atoms exceeds H100 80 GB VRAM and is not
benchmarked. Constant workload figures for 25 Å only show sizes where the
cell is large enough (≥ 50 Å) and memory permits.
